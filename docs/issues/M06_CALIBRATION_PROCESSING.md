...
- 状态：Done（2026-09-05 自动化轮：t3 复审 VERDICT=PASS（无 P0/P1/P2，2 项 P3 挂账）后自动合并，见 [docs/reports/ISSUE_031_REVIEW_REPORT.md](../reports/ISSUE_031_REVIEW_REPORT.md)）
- 直接依赖：ISSUE-030
- 映射：FR-004、012、016
...
- 状态：Done（2026-09-05 自动化轮：t3 复审 VERDICT=PASS（无 P0/P1/P2，4 项 P3 挂账）后自动合并，见 [docs/reports/ISSUE_032_REVIEW_REPORT.md](../reports/ISSUE_032_REVIEW_REPORT.md)）
- 直接依赖：ISSUE-027、030
- 映射：FR-011、012
...
- 状态：Done（2026-09-05 自动化轮：t3 复审 VERDICT=PASS（无 P0/P1/P2，1 项 P3 挂账）后自动合并，见 [docs/reports/ISSUE_035_REVIEW_REPORT.md](../reports/ISSUE_035_REVIEW_REPORT.md)）
- 直接依赖：ISSUE-030、031
- 映射：FR-012
